...
Original file is located at
    https://colab.research.google.com/drive/1-0zgWQqJEzrbzEgyEj7FKkQcpRBbfCTY
"""
...
ner_code = {
    ...
    'AF_ART_WORKS': '작품',
    'AFA_ART_CRAFT' : '회화, 조형',
    'AFA_DOCUMENT' : '도서, 지도, 지리서',
    'AFA_MUSIC' : '곡명',
    'AFA_PERFORMANCE' : '무용, 연극, 공연, 가극, 뮤지컬',
    'AFA_VIDEO' : '영화, 방송 프로그램, TV/라디오 채널',
    'AF_WARES': '상품',
    'AFW_OTHER_PRODUCTS' : '기타 공산품',
    'AFW_SERVICE_PRODUCTS' : '서비스 상품',
    'OGG_ECONOMY': '경제',
    'OGG_EDUCATION': '교육',
    'OGG_MILITARY': '군사',
    'OGG_MEDIA': '미디어 방송',
...
print(f"NER CODE : {len(ner_code)}")
print(f"NER LABEL : {len(labels)}")
